...
for ((i=2; i<=LENGTH_MAX; i++)); do
    ...
    cat "HEAD_FILE" "ke_units.m" > "ke_units_${EXP_G}_${PRIME_G}__${EXP_E}_${i}_${RED_VERSION}.m";
done;

for ((i=2; i<=LENGTH_MAX; i++)); do
    magma "ke_units_${EXP_G}_${PRIME_G}__${EXP_E}_${i}_${RED_VERSION}.m" 1>"${LOGS_DIR}/ke.units_${EXP_G}_${PRIME_G}__${EXP_E}_${i}_${RED_VERSION}" 2>&1 &
done;
